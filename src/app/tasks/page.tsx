...
import { APPLICATIONS, TaskStatus, TaskPriority } from '@/types'
...
export default function TasksPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return result
  }, [search, filterApp, filterStatus, filterPriority, filterOwner, sortKey, sortDir])
  ...
  return (
    <div>
      <Header title="All Tasks" subtitle={`${filtered.length} task${filtered.length !== 1 ? 's' : ''} found`} />
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-50">
                ...
                return (
                  <>
                    ...
                    >
                      ...
                      <td className="px-3 py-3 text-gray-500 text-xs max-w-[150px] truncate">{task.remark || '—'}</td>
                    </tr>
                    {isExpanded && (
              ...
              {paginated.length === 0 && (
                <tr>
                  <td colSpan={11} className="px-4 py-12 text-center text-gray-400">No tasks found</td>
                </tr>
              )}
            </tbody>
          </table>
